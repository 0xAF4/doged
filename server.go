...
import (
	...
	"github.com/0xaf4/doged/addrmgr"
	...
	"github.com/0xaf4/doged/connmgr"
	"github.com/0xaf4/doged/database"
	"github.com/0xaf4/doged/ltcutil"
	"github.com/0xaf4/doged/ltcutil/bloom"
	"github.com/0xaf4/doged/mempool"
	"github.com/0xaf4/doged/mining"
	"github.com/0xaf4/doged/mining/cpuminer"
	"github.com/0xaf4/doged/netsync"
	"github.com/0xaf4/doged/peer"
...
func (sp *serverPeer) OnGetData(_ *peer.Peer, msg *wire.MsgGetData) {
	...
	for i, iv := range msg.InvList {
		...
		case wire.InvTypeFilteredWitnessBlock:
			err = sp.server.pushMerkleBlockMsg(sp, &iv.Hash, c, waitChan, wire.LatestEncoding)
