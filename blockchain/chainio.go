...
func (b *BlockChain) FetchSpendJournal(targetBlock *ltcutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *ltcutil.Block) ([]SpentTxOut, error) {
...
func dbStoreBlock(dbTx database.Tx, block *ltcutil.Block) error {
