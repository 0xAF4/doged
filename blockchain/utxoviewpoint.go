...
func (view *UtxoViewpoint) AddTxOut(tx *ltcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *ltcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *ltcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *ltcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *ltcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *ltcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *ltcutil.Tx) (*UtxoViewpoint, error) {
