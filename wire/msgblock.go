...
// MsgBlock implements the Message interface and represents a litecoin
...
// BtcDecode decodes from the litecoin wire protocol as it was sent across the
...
// the litecoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new litecoin block message that conforms to the
