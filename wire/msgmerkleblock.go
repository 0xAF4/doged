...
// MsgMerkleBlock implements the Message interface and represents a litecoin
...
// NewMsgMerkleBlock returns a new litecoin merkleblock message that conforms to
