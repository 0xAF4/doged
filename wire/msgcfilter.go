...
// MsgCFilter implements the Message interface and represents a litecoin cfilter
...
// from BtcDecode in that BtcDecode decodes from the litecoin wire protocol as
...
// NewMsgCFilter returns a new litecoin cfilter message that conforms to the
