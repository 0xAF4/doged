...
// MsgReject implements the Message interface and represents a litecoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	...
	// RejectVersion.
	if pver >= RejectVersion {
		// Unfortunately the litecoin protocol does not enforce a sane
...
// NewMsgReject returns a new litecoin reject message that conforms to the
